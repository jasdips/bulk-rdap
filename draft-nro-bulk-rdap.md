...
* "versionId" -- a version 4 Universally Unique IDentifier (UUID, [@!RFC9562, section 5.4]) string that that MUST be the
  same for bulk data that was generated by the producer at a given time, such that if multiple bulk files with the same
